...
www=~www/TEST
if [[ $(whoami) == "dbhowmik" ]]; then 
    #www=/eos/user/d/dbhowmik/www/Analysis/Fit_DiPhotonTools/2017_2HDMa_Test
    www=/eos/user/d/dbhowmik/www/Analysis/Fit_DiPhotonTools/2017_2HDMa_testModCuts
    #www=/eos/user/d/dbhowmik/www/Analysis/Fit_DiPhotonTools
fi
